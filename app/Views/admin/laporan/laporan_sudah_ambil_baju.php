...
<div class="pagetitle">
  <h1>Peserta Sudah Ambil Baju</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="<?= site_url('/dashboard-admin') ?>">Dashboard</a></li>
      <li class="breadcrumb-item active">Peserta Sudah Ambil Baju</li>
    </ol>
  </nav>
</div>
    ...
    <div class="card" style="border-top: 5px solid #f97316;">
        <div class="card-body">
            <h5 class="card-title" style="color: #003366;">
                ...
                Laporan Peserta Sudah Mengambil Baju
            </h5>
            <!-- Filter Form -->
            <form method="get" class="row g-3 align-items-end mb-4">
                ...
                <div class="col-md-2">
                    <a href="<?= base_url('LaporanController/exportSudahAmbilBajuExcel?kategori=' . $filterKategori . '&search=' . $search) ?>" class="btn btn-success w-100" target="_blank">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-striped table-hover align-middle text-nowrap">
                    ...
                    <tbody>
                        <?php if (!empty($peserta)) : ?>
                            ...
                            <?php foreach ($peserta as $row) : ?>
                                <tr>
                                    ...
                                    <td><?= esc($row['kode_unik_peserta']); ?></td>
                                    <td>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="9" class="text-center text-muted">Tidak ada data yang sesuai.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
